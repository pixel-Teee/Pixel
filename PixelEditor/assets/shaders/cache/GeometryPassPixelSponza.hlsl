...
Texture2D MyAlbedo : register(t1);
Texture2D MyMetallicRoughness : register(t2);
...
Texture2DOutput18 = MyAlbedo.Sample(gsamPointWrap, Texture2DCoordinateInput17);
float2  Texture2DCoordinateInput27 = pin.TexCoord;
float4  Texture2DOutput28 = float4(0, 0, 0, 0);
Texture2DOutput28 = MyMetallicRoughness.Sample(gsamPointWrap, Texture2DCoordinateInput27);

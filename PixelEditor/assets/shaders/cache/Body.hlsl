...
Texture2D MyBaseColor : register(t0);
Texture2D MyNormal : register(t1);
...
Texture2DOutput18 = DecodeNormalMap(pin.NormalW, pin.TangentW, MyNormal.Sample(gsamPointWrap, Texture2DCoordinateInput17) * 2.0f - 1.0f);
float2  Texture2DCoordinateInput7 = pin.TexCoord;
float4  Texture2DOutput8 = float4(0, 0, 0, 0);
Texture2DOutput8 = MyBaseColor.Sample(gsamPointWrap, Texture2DCoordinateInput7);
...
float4  Normal = Texture2DOutput18;

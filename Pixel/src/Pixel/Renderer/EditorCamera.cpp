...
namespace Pixel {
	...
	void EditorCamera::OnUpdate(Timestep ts)
	{
		if (Input::IsKeyPressed(PX_KEY_LEFT_ALT))
		{
			...
			if (Input::IsMouseButtonPressed(PX_MOUSE_BUTTON_MIDDLE))
				MousePan(delta);
			else if (Input::IsMouseButtonPressed(PX_MOUSE_BUTTON_LEFT))
				MouseRotate(delta);
			else if (Input::IsMouseButtonPressed(PX_MOUSE_BUTTON_RIGHT))
				MouseZoom(delta.y);
		}
